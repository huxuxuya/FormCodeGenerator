...
Процедура ПриОткрытии(Отказ)
	...
	Если Объект.ЗапущенаКакВнешняя Тогда
		...
		Если Объект.ЗапущенаКакВнешняя = Истина Тогда
			ПоместитьФайл(Объект.АдресВнешнейОбработкиВоВременномХранилище, Объект.ИмяПодключеннойОбработки, , Ложь); 
		КонецЕсли;
...
Процедура ИнициализироватьПредварительныеНастройки()
	...
	//ВнешниеОбработки.Создать(ИмяПодключеннойОбработки, Ложь);	
...
Процедура ОбновитьИзПалитры(Команда)
    ...
    Результат = ПоместитьФайл(АдресХранилища, ИмяПодключеннойОбработки, , Ложь); 
	...
	ПолучитьФорму("ВнешняяОбработка."+ ИмяОбработки +".Форма.ФормаПалитра", ПараметрыФормы);
 	//ОткрытьФорму("ВнешняяОбработка."+ ИмяОбработки +".Форма.ФормаПалитра");
...
&НаСервере
Процедура ОбновитьИзПалитрыНаСервере(АдресХранилища)
	...
	//	ОбъектВнешнейОбработки = ВнешниеОбработки.Создать(ИмяПодключеннойОбработки, Ложь, ОбъектОписанияЗащиты);
		ВнешниеОбработки.Подключить(АдресХранилища, "ВременнаяОбработкаПолученияФормыПалитры",  Ложь, ОбъектОписанияЗащиты);
	//	ОбъектВнешнейОбработки.ПолучитьФорму("ФормаПалитра", ЭтаФорма);
		
	//ИмяВременногоФайла = КаталогВременныхФайлов()+"ВременнаяОбработкаПолученияФормыПалитры.epf";
