...
Процедура ПриОткрытии(Отказ)
	...
	Если ПустаяСтрока(Объект.ТекстШаблонаОкружения) Тогда
		...
		ШабонОбслуживающегоМетода = НСтр("ru = '&НаСервере
...
Процедура ОбновитьОбщийТекстПрограмногоДобаления()
	...
	Объект.ТекстПрограммногоДобавления = Объект.ТекстДобавленияРеквизитов + Объект.ТекстДобавленияКоманд + Объект.ТекстДобавленияЭлементов + Объект.ТекстОбслуживающихМетодов;
