Процедура ПодготовитьДанныеАнализируемойФормы(Форма) Экспорт
	...
	Если Форма.Параметры.Свойство("РедакторФорм") Тогда
		...
		ПараметрыДекомпиляции = ПолучитьИзВременногоХранилища(НастройкиРедакторФорм.АдресВоВременномХранилище);
...
Функция НовоеСоответствиеТекстовыхПредставлений()
...
Функция НовоеСоответствиеПредставленийТипов()
