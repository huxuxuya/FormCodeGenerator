...
Процедура СформироватьКодПоСтрокам(ДеревоЭлементов, ПараметрыФорм)
	...
	Для Индекс = 1 По КоличествоСтрок Цикл
		...
		ФильтроватьМетодыДобавленияПолейФормы(МетодыТипов, ТекЭлемент, ТекРодительЭлемента);
...
Процедура ФильтроватьМетодыДобавленияПолейФормы(МетодыТипов, ТекЭлемент, ТекРодительЭлемента)
